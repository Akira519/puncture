...
class SodiumCrypto(object):
    def __init__(self, cipher_name, key, iv, op, crypto_path=None):
        ...
        # 20170820 bugFix, solve  memory issue, till now this issue still not merge in master version
        # look like python version is out of maintain ???
        # https://github.com/shadowsocks/shadowsocks/pull/921
